...
public class InputStateKey {
    ...
    private static void logInputSnapshot(String reason) {
        ...
        LocalPlayer player = Minecraft.getInstance().player;
        if (player == null) {
            YesSteveModel.LOGGER.info("[YSM-INPUT] {} player=null mouse0={} mouse1={} usePulse={} useAge={} useHand={} swingPulse={} swingAge={} swingHand={}",
                    reason, mouseStates[0], mouseStates[1], usePulseTicks, usePulseAge, usePulseHand, swingPulseTicks, swingPulseAge, swingPulseHand);
            return;
        }
        Minecraft minecraft = Minecraft.getInstance();
        YesSteveModel.LOGGER.info("[YSM-INPUT] {} mouse0={} mouse1={} attackKey={} useKey={} vanillaSwinging={} vanillaSwingArm={} attackAnim={} usingItem={} usedHand={} usePulse={} useAge={} useHand={} swingPulse={} swingAge={} swingHand={} mainItem={} offItem={}",
                reason,
                mouseStates[0],
                mouseStates[1],

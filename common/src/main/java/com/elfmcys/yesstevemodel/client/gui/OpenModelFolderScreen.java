...
public class OpenModelFolderScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick) {
        ...
        drawWordWrap(guiGraphics, Component.translatable("gui.yes_steve_model.open_model_folder.tips"), (this.width - 400) / 2, (this.height / 2) - 80, 400, 0xFFFFFFFF);
        super.extractRenderState(extractor, mouseX, mouseY, partialTick);
    }

    private void drawWordWrap(GuiGraphicsExtractor guiGraphics, Component component, int x, int y, int width, int color) {
